...
def generate_forecast(historical_df, events_df, periods=15):
    ...
    # Parameters for our robust Sales Model.
    lgbm_params_sales = {
        'objective': 'quantile',
        'alpha': 0.5,
        # // SENIOR DEV NOTE //: THIS IS THE FIX. The 'metric' parameter for the scikit-learn
        # wrapper does not accept 'quantile'. We use 'regression_l1' (MAE) for evaluation,
        # which is compatible. The core 'objective' remains 'quantile', ensuring our model
        # is still robust to outliers.
        'metric': 'regression_l1', # Changed from 'quantile' to 'regression_l1'
