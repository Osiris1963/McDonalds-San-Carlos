...
def generate_forecast(historical_df, events_df, periods=15):
    ...
    # The Trainer arguments are updated for pytorch-lightning v1.9.5 API
    trainer = pl.Trainer(
        max_epochs=20,
        # 'accelerator' is replaced by 'gpus' or 'tpu_cores' in older versions.
        # For CPU, we simply don't specify it.
        enable_model_summary=False,
        gradient_clip_val=0.1,
        # The 'logger=False' argument is still valid.
        logger=False,
        # Add a callback for checkpointing the best model
    ...
    # The trainer.fit call remains the same
    trainer.fit(
        tft,
    ...
    # The prediction logic also needs to be updated to use the older API
